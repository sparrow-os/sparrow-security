...
CREATE TABLE `t_group_role` (
 ...
 `group_id` int(10)  DEFAULT 0 COMMENT 'group id'  NOT NULL,
 `role_id` int(10)  DEFAULT 0 COMMENT 'role id'  NOT NULL,
...
PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='t_group_role';
